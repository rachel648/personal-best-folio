import { Code, Palette, Zap, Users,Smartphone } from "lucide-react";
...
const About = () => {
  const skills = [
    ...
    },
    {
      ...
      description: "Node.js, Python, PostgreSQL, MongoDB, Express.js,Firebase, RESTful APIs,Django,Flask,Express.js",
...

    {
      ...
      description: "Android (Java),(Kotlin),Flutter (Dart), Firebase Integration",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              I'm a passionate developer with 5+ years of experience building innovative
              digital solutions that blend beautiful design with powerful functionality
              and seamless user experiences. I specialize in modern web technologies and mobile development,
              backend systems, and emerging technologies like AI, delivering elegant solutions to
              complex problems.
            </p>
          </div>
