...
const Projects = () => {
  const projects = [
    ...
    },
    {
      id: 2,
      title: "AI Dashboard",
      description: "An intelligent dashboard for data visualization and analytics. Built with Next.js and integrated with machine learning APIs for predictive insights.",
      image: project2,
    ...
    },
    {
      ...
      description: "A secure mobile banking application with biometric authentication, real-time transactions, and intuitive user interface design.",
      image: project3,
