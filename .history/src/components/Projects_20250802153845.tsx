  ...
  const projects = [
    {
      ...
      description: "A modern, responsive e-commerce platform built with React, TypeScript, and Stripe integration. Features include real-time inventory, user authentication, and advanced search functionality.",
      image: project1,
