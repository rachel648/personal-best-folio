  ...
  const projects = [
    {
      ...
      description: "A secure mental health platform developed with Java and Firebase, enabling private consultations, progress tracking, and peer support communities. It focuses on confidentiality and AI-driven recommendations to enhance user experience.",
      image: project1,
      technologies: ["Java", "Firebase", "AI (Planned)", "Android Studio"],
    ...
    },
    {
      id: 2,
      title: "Yoga Demo App",
      description: "A fitness and wellness application with Google Calendar integration, notifications, BMI calculator, and consultant-patient navigation. Built to improve physical and mental well-being through structured sessions and tracking tools.",
      image: project2,
      technologies: ["Java", "Firebase", "Google Calendar API", "Android Studio"],
    ...
    },
    {
      ...
      description: "A Java-based health management system for client registration, program enrollment, and secure data handling. Includes API exposure for integrations and user-friendly interfaces for healthcare providers.",
      image: project3,
      technologies: ["Java", "SQLite", "RESTful API", "Android Studio"],
      liveUrl: "https://example.com",
      githubUrl: "https://github.com",
      featured: false,
    },
